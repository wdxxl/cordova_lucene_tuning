...
//  source: jar:file:gson-2.8.2-sources.jar!com/google/gson/JsonArray.java
//
...
FOUNDATION_EXPORT void ComGoogleGsonJsonArray_initWithInt_(ComGoogleGsonJsonArray *self, jint capacity);

FOUNDATION_EXPORT ComGoogleGsonJsonArray *new_ComGoogleGsonJsonArray_initWithInt_(jint capacity) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleGsonJsonArray *create_ComGoogleGsonJsonArray_initWithInt_(jint capacity);

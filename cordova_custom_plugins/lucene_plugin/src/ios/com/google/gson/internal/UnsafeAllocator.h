...
//  source: jar:file:gson-2.8.2-sources.jar!com/google/gson/internal/UnsafeAllocator.java
//
...
FOUNDATION_EXPORT void ComGoogleGsonInternalUnsafeAllocator_assertInstantiableWithIOSClass_(IOSClass *c);
